		...
		<div className='flex h-12 shrink-0 items-center gap-2 border-line border-b px-3'>
			...
			<div className='flex min-w-0 flex-col gap-0.5'>
				<div className='flex items-center gap-1.5 text-[11px]'>
					<span className='truncate text-ink'>{BREADCRUMB.project}</span>
					...
					<span className='ml-1 flex shrink-0 items-center gap-1 rounded-md px-1 py-0.5 text-[10px] text-muted'>
						...
						{BREADCRUMB.target}
						<ChevronsIcon className='size-2.5 text-muted/60' />
					</span>
				</div>
		...
		<div className='shrink-0 p-2.5'>
			<div className='rounded-lg border border-line bg-surface p-2.5'>
				...
				<div className='mt-8 flex items-center gap-1'>
					<span className='flex items-center gap-1 rounded-md px-1 py-0.5 text-[10px] text-muted'>
						<SparkIcon className='size-3' />
						{COMPOSER.model}
					</span>
					<span className='flex items-center gap-1 rounded-md bg-warning/10 px-1.5 py-0.5 text-[10px] text-warning'>
						<BarsIcon className='size-3' />
						{COMPOSER.thinking}
					</span>
					<BookIcon className='size-3.5 shrink-0 text-muted/65' />
					<span className='ml-auto flex shrink-0 items-center gap-2'>
						<PlugIcon className='size-3.5 text-muted/65' />
						<GaugeIcon className='size-3.5 text-muted/65' />
...
export function MockConversation() {
	return (
		<div className={cn('flex h-full min-w-0 flex-1 flex-col')}>
			<Header />
			<TabStrip />
